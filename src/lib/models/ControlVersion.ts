...
export interface ControlVersionAttributes {
  id: string
  control_id: string
...
export class ControlVersion extends Model<ControlVersionAttributes> implements ControlVersionAttributes {
  declare id: string
...
ControlVersion.init(
  ...
  },
  {
    ...
    indexes: [
      {
        unique: true,
        fields: ['control_id', 'version_label'],
      },
    ],
  },
)
